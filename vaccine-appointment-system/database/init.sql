...
VALUES (1, '重组乙型肝炎疫苗（CHO细胞）10μg', '华北制药金坦生物',
       ...
       (23, '皮内注射用卡介苗（BCG）', '成都生物制品研究所',
        ...
        '周一至周五 8:00-11:30, 14:00-16:30', 1, '新生儿（出生24小时内），未接种的PPD阴性儿童',
        '预防结核病（尤其重症结核）'),
       -- 24: 脊灰灭活疫苗 IPV
       ...
       (33, '23价肺炎球菌多糖疫苗（国产）', '成都生物制品研究所',
        ...
        '周一至周五 8:00-11:30, 14:00-16:30', 1, '2岁以上高危人群（65岁以上老人、慢性病患者）',
        '预防23种血清型肺炎球菌性疾病'),
       -- 34: 四价流感病毒亚单位疫苗
       ...
       (38, '口服重组B亚单位/菌体霍乱疫苗（肠溶胶囊）', '上海联合赛尔生物工程',
        ...
        '周一至周五 8:00-11:30, 14:00-16:30', 3, '2岁以上前往霍乱疫区旅行者及疫区高危人群',
        '预防霍乱O1群及ETEC旅行者腹泻'),
       -- 39: 黄热病减毒活疫苗
