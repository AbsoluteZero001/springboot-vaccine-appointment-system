-- ============================================================================
-- 疫苗预约系统 — MySQL Docker 初始化脚本 (开箱即用)
-- ============================================================================
-- 说明:
--   本文件挂载到 MySQL 容器的 /docker-entrypoint-initdb.d/
--   容器首次启动时自动执行，完成建库建表 + 初始数据填充
--
-- 包含内容:
--   1. 字符集设置 (utf8mb4)
--   2. 清理旧表 (幂等安全)
...
--      - 普通用户通过注册页面自行注册，不预置
--   5. 疫苗图片说明:
--      数据库中使用 Unsplash 占位图片 URL 作为引导
--      上线后请在管理后台上传真实疫苗图片进行替换
-- ============================================================================
...
VALUES ('admin', '$2b$10$o1DD40tNdnPaRQ0hW8pbT.l5/Ao3/EtvOcHU9p0rrpp/fiD/ST3Uq',
        '13800000000', 'ROLE_ADMIN', 1, NOW(), NOW());
...
(3, '重组乙型肝炎疫苗（汉逊酵母）10μg', '大连汉信生物制药',
 ...
 '10μg/0.5ml', '汉逊酵母', '周一至周五 8:00-11:30, 14:00-16:30', 3, '16岁以下儿童/青少年',
 '预防乙型肝炎病毒感染', 0, NOW(), NOW()),
(4, '重组乙型肝炎疫苗（汉逊酵母）20μg', '大连汉信生物制药',
 '汉逊酵母表达，20μg规格，适用于成人和高危人群。', 850, TRUE,
 'https://images.unsplash.com/photo-1559757148-5c350d0d3c56?w=400&h=300&fit=crop', '乙肝疫苗', '大连汉信',
 '20μg/1.0ml', '汉逊酵母', '周一至周五 8:00-11:30, 14:00-16:30', 3, '16岁以上及成人',
 '预防乙型肝炎病毒感染', 0, NOW(), NOW()),
(5, '重组乙型肝炎疫苗（酿酒酵母）10μg', '葛兰素史克（GSK）',
 ...
 '10μg/0.5ml', '酿酒酵母', '周一至周五 8:00-11:30, 14:00-16:30', 3, '全年龄段（婴幼儿/儿童）',
 '预防乙型肝炎病毒感染', 0, NOW(), NOW()),
(6, '重组乙型肝炎疫苗（酿酒酵母）20μg', '葛兰素史克（GSK）',
 '酿酒酵母表达，20μg规格，成人标准免疫剂量。', 700, TRUE,
 'https://images.unsplash.com/photo-1559757148-5c350d0d3c56?w=400&h=300&fit=crop', '乙肝疫苗', 'Engerix-B',
 '20μg/1.0ml', '酿酒酵母', '周一至周五 8:00-11:30, 14:00-16:30', 3, '成人（20岁以上）',
 '预防乙型肝炎病毒感染', 0, NOW(), NOW()),
...
(9, '四价人乳头瘤病毒疫苗（酿酒酵母）', '默沙东（MSD）',
 ...
 '0.5ml', '重组蛋白（酿酒酵母）', '周一至周五 8:00-11:30（仅上午接种）', 3, '20-45岁女性',
 '预防宫颈癌及生殖器疣', 0, NOW(), NOW()),
...
-- ────────────────────────────────────────────────────────────────────
-- 三、流感疫苗系列 (3种: #11-12, #34)
-- ────────────────────────────────────────────────────────────────────
(11, '四价流感病毒裂解疫苗', '华兰生物',
 '覆盖两种甲型（H1N1/H3N2）和两种乙型（Victoria/Yamagata）流感病毒株，季节首选。', 1500, TRUE,
 'https://images.unsplash.com/photo-1559757148-5c350d0d3c56?w=400&h=300&fit=crop', '流感疫苗', '华兰生物',
 '0.5ml', '裂解灭活', '周一至周日 8:00-16:30（节假日不休）', 1, '6月龄以上全年龄段',
 '预防季节性流行性感冒', 0, NOW(), NOW()),
...
(34, '四价流感病毒亚单位疫苗', '江苏中慧元通生物科技',
 '亚单位工艺流感疫苗，纯度更高、不良反应更少，覆盖四种流感毒株。', 1000, TRUE,
...
(14, '13价肺炎球菌多糖结合疫苗', '辉瑞（Pfizer）',
 ...
 '0.5ml', '多糖结合', '周一至周五 8:00-11:30, 14:00-16:30', 4, '6周龄-5岁婴幼儿',
 '预防婴幼儿肺炎球菌性疾病', 0, NOW(), NOW()),
(32, '13价肺炎球菌多糖结合疫苗（国产）', '云南沃森生物技术',
 '国产13价肺炎球菌结合疫苗（沃安欣），CRM197载体，婴幼儿肺炎防护首选。', 600, TRUE,
...
(35, '带状疱疹减毒活疫苗', '长春百克生物科技',
 '国产带状疱疹减毒活疫苗（感维），单次皮下注射，40岁以上即可接种。', 500, TRUE,
 'https://images.unsplash.com/photo-1584467735871-8db9ac8d091c?w=400&h=300&fit=crop', '带状疱疹疫苗', '感维',
 '0.5ml/支', '减毒活病毒', '周一至周五 8:00-11:30, 14:00-16:30', 1, '40岁及以上成人',
 '预防带状疱疹及后遗神经痛', 0, NOW(), NOW()),

-- ────────────────────────────────────────────────────────────────────
-- 六、新冠 / 狂犬 / 水痘 / 百白破 / 乙脑 / 流脑 系列 (#16-22)
-- ────────────────────────────────────────────────────────────────────
...
(19, '甲型肝炎灭活疫苗', '长春生物制品研究所',
 ...
 '0.5ml', '灭活病毒', '周一至周五 8:00-11:30, 14:00-16:30', 2, '18月龄以上儿童及成人',
 '预防甲型肝炎', 0, NOW(), NOW()),
(20, '吸附无细胞百白破联合疫苗', '赛诺菲（Sanofi）',
 ...
 '0.5ml', '灭活/类毒素', '周一至周五 8:00-11:30, 14:00-16:30', 4, '3月龄-6岁儿童',
 '预防百日咳、白喉、破伤风', 0, NOW(), NOW()),
(21, '流行性乙型脑炎减毒活疫苗', '成都生物制品研究所',
 ...
 '0.5ml', '减毒活病毒', '周一至周五 8:00-11:30, 14:00-16:30', 2, '8月龄-6岁儿童',
 '预防流行性乙型脑炎', 0, NOW(), NOW()),
(22, 'A+C群脑膜炎球菌多糖疫苗', '武汉生物制品研究所',
 ...
 '0.5ml', '多糖', '周一至周五 8:00-11:30, 14:00-16:30', 2, '6月龄-15岁儿童',
 '预防A/C群流行性脑脊髓膜炎', 0, NOW(), NOW()),

-- ────────────────────────────────────────────────────────────────────
-- 七、卡介苗 / 脊灰 / 麻疹 / 麻腮风 系列 (#23-27)
-- ────────────────────────────────────────────────────────────────────
...
(24, '脊髓灰质炎灭活疫苗（IPV，Sabin株）', '中国医学科学院医学生物学研究所',
 ...
 '0.5ml/支', '灭活病毒', '周一至周五 8:00-11:30, 14:00-16:30', 4, '2月龄及以上婴幼儿',
 '预防脊髓灰质炎（小儿麻痹症）', 0, NOW(), NOW()),
(25, '二价口服脊髓灰质炎减毒活疫苗（bOPV）', '北京天坛生物制品研究所',
 ...
 '2滴/0.1ml', '减毒活病毒（口服）', '周一至周五 8:00-11:30, 14:00-16:30', 2, '4月龄及4周岁儿童',
 '预防脊髓灰质炎', 0, NOW(), NOW()),
(26, '麻疹减毒活疫苗', '北京天坛生物制品研究所',
 ...
 '0.5ml/支', '减毒活病毒', '周一至周五 8:00-11:30, 14:00-16:30', 1, '8月龄以上无麻疹免疫史儿童',
 '预防麻疹', 0, NOW(), NOW()),
...
(31, '肠道病毒71型灭活疫苗（人二倍体细胞）', '北京科兴生物制品',
 ...
 '0.5ml/支', '灭活病毒', '周一至周五 8:00-11:30, 14:00-16:30', 2, '6月龄至5周岁儿童',
 '预防EV71型重症手足口病', 0, NOW(), NOW()),

-- ────────────────────────────────────────────────────────────────────
-- 九、出血热 / 钩端螺旋体 / 霍乱 / 黄热病 / 登革热 系列 (#36-40)
-- ────────────────────────────────────────────────────────────────────
...
-- ────────────────────────────────────────────────────────────────────
-- 十、甲肝补充 / 乙肝加强 / 腮腺炎 / 风疹 / 流脑四价 系列 (#41-46)
-- ────────────────────────────────────────────────────────────────────
(41, '甲型肝炎灭活疫苗（儿童剂型）', '北京科兴生物制品',
 ...
 '0.5ml/支（250U）', '灭活病毒', '周一至周五 8:00-11:30, 14:00-16:30', 2, '12月龄至15周岁儿童',
 '预防甲型肝炎', 0, NOW(), NOW()),
